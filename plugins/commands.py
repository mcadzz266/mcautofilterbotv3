...
async def start(client, message):
    if message.chat.type in [enums.ChatType.GROUP, enums.ChatType.SUPERGROUP]:
        buttons = [
            [
                InlineKeyboardButton('🔔 Channel Updates 🤖', url='https://telegram.me/mc_adzz')
            ],
            [
                InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/Moviecomplexofficialgroup"),
            ],
            [
    ...
    if len(message.command) != 2:
        buttons = [[
            ...
            InlineKeyboardButton('⚡ Movie Updates ⚡', url=f"https://telegram.me/moviecomplexofficialgroup"),
            InlineKeyboardButton('🔔 Channel Updates 🤖', url='https://t.me/Mc_adzz')
            ],[
    ...
    await client.send_cached_media(
        ...
        file_id=file_id,
        caption=f_caption,
        reply_markup=InlineKeyboardMarkup( [ [InlineKeyboardButton('ꜰᴏʟʟᴏᴡ', url='https://telegram.me/mc_adzz')] ] ),
        protect_content=True if pre == 'filep' else False,
        )
